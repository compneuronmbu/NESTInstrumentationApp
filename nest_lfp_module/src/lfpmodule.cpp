...
mynest::LfpModule lfpmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

mynest::LfpModule::LfpModule()
{
#ifdef LINKED_MODULE
...
const std::string
mynest::LfpModule::name( void ) const
{
  return std::string( "LFP Module" ); // Return name of the module
}

const std::string
mynest::LfpModule::commandstring( void ) const
{
  // Instruct the interpreter to load lfpmodule-init.sli
  return std::string( "(lfpmodule-init) run" );
}

//-------------------------------------------------------------------------------------

void
mynest::LfpModule::init( SLIInterpreter* i )
{
  /* Register a neuron or device model.
     Give node type as template argument and the name as second argument.
  */
  nest::kernel().model_manager.register_node_model< lfp_detector >(
    "lfp_detector" );
